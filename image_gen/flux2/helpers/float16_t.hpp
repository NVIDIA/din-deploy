...
constexpr inline std::uint16_t half_div(std::uint16_t x, std::uint16_t y) noexcept
{
    ...
    if (x_is_inf)
        return static_cast<std::uint16_t>(sign | h_inf);
    if (y_is_inf)
        return static_cast<std::uint16_t>(sign);  // zero with sign
...
struct float16_t
{
    ...
    constexpr inline float16_t(std::uint16_t bits) noexcept
        : data_{bits}
    {
    }
...
constexpr inline auto fmod = float16_t_private::make_binary_function(
    [](float f1, float f2)
    {
        return std::fmod(f1, f2);
    });
constexpr inline auto remainder = float16_t_private::make_binary_function(
    [](float f1, float f2)
    {
        return std::remainder(f1, f2);
    });
// remquo ??
constexpr inline auto fma = float16_t_private::make_trinary_function(
    [](float f1, float f2, float f3)
    {
        return std::fma(f1, f2, f3);
    });
constexpr inline auto fmax = float16_t_private::make_binary_function(
    [](float f1, float f2)
    {
        return std::fmax(f1, f2);
    });
constexpr inline auto fmin = float16_t_private::make_binary_function(
    [](float f1, float f2)
    {
        return std::fmin(f1, f2);
    });
constexpr inline auto fdim = float16_t_private::make_binary_function(
    [](float f1, float f2)
    {
        return std::fdim(f1, f2);
    });
constexpr inline auto lerp = float16_t_private::make_trinary_function(
    [](float f1, float f2, float f3)
    {
        return f1 + f3 * (f2 - f1);
    });
constexpr inline auto exp = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::exp(f);
    });
constexpr inline auto exp2 = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::exp2(f);
    });
constexpr inline auto expm1 = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::expm1(f);
    });
constexpr inline auto log = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::log(f);
    });
constexpr inline auto log10 = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::log10(f);
    });
constexpr inline auto log2 = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::log2(f);
    });
constexpr inline auto log1p = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::log1p(f);
    });
constexpr inline auto pow = float16_t_private::make_binary_function(
    [](float f1, float f2)
    {
        return std::pow(f1, f2);
    });
constexpr inline auto sqrt = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::sqrt(f);
    });
constexpr inline auto cbrt = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::cbrt(f);
    });
...
constexpr inline auto sin = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::sin(f);
    });
constexpr inline auto sinh = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::sinh(f);
    });
constexpr inline auto cos = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::cos(f);
    });
constexpr inline auto cosh = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::cosh(f);
    });
constexpr inline auto tan = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::tan(f);
    });
constexpr inline auto tanh = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::tanh(f);
    });
constexpr inline auto asin = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::asin(f);
    });
constexpr inline auto asinh = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::asinh(f);
    });
constexpr inline auto acos = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::acos(f);
    });
constexpr inline auto acosh = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::acosh(f);
    });
constexpr inline auto atan = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::atan(f);
    });
constexpr inline auto atanh = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::atanh(f);
    });
constexpr inline auto atan2 = float16_t_private::make_binary_function(
    [](float f1, float f2)
    {
        return std::atan2(f1, f2);
    });

constexpr inline auto erf = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::erf(f);
    });
constexpr inline auto erfc = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::erfc(f);
    });
constexpr inline auto tgamma = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::tgamma(f);
    });
constexpr inline auto lgamma = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::lgamma(f);
    });
constexpr inline auto ceil = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::ceil(f);
    });
constexpr inline auto floor = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::floor(f);
    });
constexpr inline auto trunc = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::trunc(f);
    });
constexpr inline auto round = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::round(f);
    });
constexpr inline auto nearbyint = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::nearbyint(f);
    });
constexpr inline auto rint = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::rint(f);
    });
...
constexpr inline auto logb = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::logb(f);
    });
constexpr inline auto nextafter = float16_t_private::make_binary_function(
    [](float f1, float f2)
    {
        return std::nextafter(f1, f2);
    });
constexpr inline auto copysign = float16_t_private::make_binary_function(
    [](float f1, float f2)
    {
...
constexpr inline auto beta = float16_t_private::make_binary_function(
    [](float f1, float f2)
    {
        return std::beta(f1, f2);
    });
constexpr inline auto comp_ellint_1 = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::comp_ellint_1(f);
    });
constexpr inline auto comp_ellint_2 = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::comp_ellint_2(f);
    });
...
constexpr inline auto expint = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::expint(f);
    });
constexpr inline auto riemann_zeta = float16_t_private::make_unary_function(
    [](float f)
    {
        return std::riemann_zeta(f);
    });
#endif
